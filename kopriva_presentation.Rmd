...
```{r, out.width = "600px", echo = FALSE, fig.align='right'}
...
| <font size="5"> Does the content of these workshops reflect the data science skills used by graduate students in their research? |  | <font size="5"> Collection of research (`R`) code |  
...
- Context: environmental science data promotes learning transfer

## `R` for Data Science Workshops    

| <font size="5"> |                              |    
|:----------------|:----------------------------:|  
| <font size="5"> Introduction to `R` | <font size="5"> objects in `R`, working in `R`, inspecting, extracting, wrangling, summarizing, and visualizing data with base `R` tools |  
